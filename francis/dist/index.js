...
const weather_1 = __importDefault(require("./apis/weather"));
 ...
 */
const francisTool = (0, tools_1.createTool)({
    /**
    ...
    async execute(input, config, context) {
        ...
        try {
            ...
            const dateRange = (0, utils_1.getDateRange)(startDate, endDate);
            console.log(input);
            ...
            const { data: weatherData, error: weatherError } = await supabase
                ...
                .insert(forecasts);
            const scrapping = await new Promise((resolve, reject) => {
                const python = (0, child_process_1.spawn)('python3', ['src/scripts/betterScrapper.py'], {
                    env: {
                        ...process.env,
